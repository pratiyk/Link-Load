...
const OWASPScanner = () => {
  ...
  const exportReport = async (format = "pdf") => {
    ...
    try {
      ...
      link.href = url;
      link.setAttribute('download', `scan-report-${currentScan.scan_id}.${format}`);
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      case 'completed': 
        return <CheckCircle2 size={20} style={{ color: '#10B981' }} strokeWidth={2} />;
      case 'failed': 
        return <XCircle size={20} style={{ color: '#DC2626' }} strokeWidth={2} />;
      case 'cancelled': 
        return <XCircle size={20} style={{ color: '#F59E0B' }} strokeWidth={2} />;
      case 'in-progress': 
    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', gap: 'var(--spacing-2)' }}>
          <button
            className={activeTab === "bookmark" ? "btn btn-primary" : "btn btn-secondary"}
      ...
      <div style={{
        ...
        <button
          style={{
            ...
            fontWeight: '500',
            border: 'none',
            borderBottom: activeTab === "new-scan" ? '2px solid var(--color-accent)' : '2px solid transparent',
            background: 'transparent',
            color: activeTab === "new-scan" ? 'var(--color-accent)' : 'var(--color-text-secondary)',
            cursor: 'pointer',
            transition: 'all 0.2s',
            display: 'flex',
            alignItems: 'center',
        ...
        <button
          style={{
            ...
            fontWeight: '500',
            border: 'none',
            borderBottom: activeTab === "scan-details" ? '2px solid var(--color-accent)' : '2px solid transparent',
            background: 'transparent',
            color: activeTab === "scan-details" ? 'var(--color-accent)' : 'var(--color-text-secondary)',
        ...
        <button
          style={{
            ...
            fontWeight: '500',
            border: 'none',
            borderBottom: activeTab === "scan-progress" ? '2px solid var(--color-accent)' : '2px solid transparent',
            background: 'transparent',
            color: activeTab === "scan-progress" ? 'var(--color-accent)' : 'var(--color-text-secondary)',
            cursor: currentScan ? 'pointer' : 'not-allowed',
            transition: 'all 0.2s',
            display: 'flex',
            alignItems: 'center',
        ...
        <button
          style={{
            ...
            background: 'transparent',
            color: activeTab === "results" ? 'var(--color-accent)' : 'var(--color-text-secondary)',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-4)' }}>
              ...
              <div>
                ...
                <div style={{ 
                  ...
                  {[
                    { value: "zap_active", label: "ZAP Active Scan (Comprehensive)" },
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          const newTypes = e.target.checked
                            ...
                            : scanConfig.scan_types.filter(t => t !== type.value);
                          setScanConfig({...scanConfig, scan_types: newTypes});
                        }}
                        style={{ 
                ...
                <div style={{ 
                  ...
                  <label style={{ 
                    ...
                    <input
                      ...
                      onChange={(e) => setScanConfig({...scanConfig, include_low_risk: e.target.checked})}
                      style={{ 
                        marginRight: 'var(--spacing-2)',
                        cursor: 'pointer'
                      }}
                  ...
                  <label style={{ 
                    ...
                    <input
                      ...
                      onChange={(e) => setScanConfig({...scanConfig, authenticated: e.target.checked})}
                      style={{ 
                        marginRight: 'var(--spacing-2)',
                        cursor: 'pointer'
                      }}
              ...
              <div style={{ 
                ...
                <div
                  style={{ 
                    ...
                    background: currentScan.status === "failed" 
                  ...
                  >
                    <div style={{ 
                      ...
                      <span className={`badge ${
                        ...
                        : vuln.severity === 'medium' ? 'badge-warning'
                        : 'badge-info'
                      }`} style={{ 
          ...
          >
            ...
            <div style={{ 
              ...
              <div>
                ...
                <span className={`badge ${
                  selectedVuln.severity === 'critical' ? 'badge-danger'
                  : selectedVuln.severity === 'high' ? 'badge-danger'
                  : selectedVuln.severity === 'medium' ? 'badge-warning'
                  : 'badge-info'
                }`} style={{ 
                  textTransform: 'uppercase',
                  fontSize: 'var(--font-size-sm)'
