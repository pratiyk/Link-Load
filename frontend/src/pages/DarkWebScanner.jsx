...
import { scanDarkWeb } from "../services/darkWebScanner";
import {
  Eye,
  Mail,
  ScanSearch,
...
export default function DarkWebScanner() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const data = await scanDarkWeb(email);
    ...
    <div style={{ maxWidth: "900px", margin: "0 auto" }}>
      ...
      {results.length > 0 && (
        <div className="card">
          ...
          >
            Your email was found in {results.length} data breach
            {results.length > 1 ? "es" : ""}. Please change your passwords
            immediately.
          </p>
          ...
          {results.map((result, index) => (
            <div
              ...
              style={{
                marginBottom:
                  index < results.length - 1 ? "var(--spacing-5)" : 0,
                paddingBottom:
                  index < results.length - 1 ? "var(--spacing-5)" : 0,
                borderBottom:
